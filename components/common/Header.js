        ...
        <div className="bg-white max-w-7xl mx-auto flex flex-wrap items-center justify-between ps-6 py-3 pe-3 border-b border-gray-200 rounded-2xl">
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul className="flex flex-col md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-1 md:flex-row md:mt-0 md:border-0 md:bg-white">
              <li>
                <Link href="/" className="py-2 px-3 rounded md:bg-transparent md:text-primary md:p-0 " aria-current="page"><svg className="nav-icon" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <li>
                <Link href="/pages/about" className="py-2 px-3 text-gray-900 rounded md:p-0 "> <svg className="nav-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <li>
                <Link href="/pages/services" className="py-2 px-3 text-gray-900 rounded md:p-0    "> <svg className="nav-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <Link href="/pages/works" className="py-2 px-3 text-gray-900 rounded md:p-0"><svg className="nav-icon" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <li>
                <Link href="/pages/blog" className="py-2 px-3 text-gray-900 rounded md:p-0"> <svg className="nav-icon" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
              ...
              <li>
                <Link href="/pages/contact" className="py-2 px-3 text-gray-900 rounded md:p-0"><svg className="nav-icon" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
